        ...
        <div className={styles.profile}>
            <div className={styles.profile__container}>
                ...
                <div className={styles.changepassword}>
                    ...
                    <input className={styles.changepassword__input} value='Maxim23' disabled type="password"/>
              ...
              <div className={styles.changepassword}>
                ...
                <input className={styles.changepassword__input} disabled value='Максим' type="text"/>
                <div className={styles.changepassword__button}>
                  <Button text="Изменить"/>
                </div>
              </div>
